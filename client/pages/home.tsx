	...
	return (
		<div className='h-screen overflow-hidden'>
			...
			<div className='h-3/5 p-6'>
				<div className='flex h-full flex-wrap justify-center gap-4 pb-20 pt-6 text-center'>
					<div className='flex w-1/3 flex-col items-center justify-center'>
						...
						<p className='pt-2 text-sm'>Ride</p>
					</div>
					...
					<div className='flex w-1/3 flex-col items-center justify-center'>
						...
						<p className='pt-2 text-sm'>Locations</p>
					</div>
					...
					<div className='flex w-1/3 flex-col items-center justify-center'>
						...
						<p className='pt-2 text-sm'>Messages</p>
					</div>
					...
					<div className='flex w-1/3 flex-col items-center justify-center'>
						...
						<p className='pt-2 text-sm'>Reviews</p>
					</div>
				</div>
			</div>
