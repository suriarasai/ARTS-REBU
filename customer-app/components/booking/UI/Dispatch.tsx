...
const Dispatch = () => {
	const booking = useRecoilValue(bookingAtom) as bookingEvent
...
const TripStatistics = ({ booking }: { booking: bookingEvent }) => (
...
const TripInformation = ({ booking }: { booking: bookingEvent }) => (
...
const DriverInformation = ({ booking }: { booking: bookingEvent }) => (
