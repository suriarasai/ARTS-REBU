...
export const Popup = ({ msg }) => {
	...
	return (
		<div className='border-grey absolute left-0 right-0 top-0 ml-auto mr-auto mt-8 flex w-96 justify-center rounded-lg border bg-gray-700 px-5 py-4 shadow-lg'>
